"""
Vanilla RNN-based Seq2Seq model for text-to-code generation.
"""
...
class VanillaRNNSeq2Seq(nn.Module):
    """Seq2Seq model with vanilla RNN encoder and decoder."""
    ...
    def __init__(self, input_vocab_size, output_vocab_size, embedding_dim=128, 
        ...
        self.encoder = RNNEncoder(input_vocab_size, embedding_dim, hidden_dim, num_layers, dropout)
        self.decoder = RNNDecoder(output_vocab_size, embedding_dim, hidden_dim, num_layers, dropout)
