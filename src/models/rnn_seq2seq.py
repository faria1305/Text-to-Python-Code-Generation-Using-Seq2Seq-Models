...
class RNNDecoder(nn.Module):
    ...
    def forward_step(self, inp: torch.Tensor, hidden: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
...
class Seq2SeqRNN(nn.Module):
    def __init__(self, encoder: RNNEncoder, decoder: RNNDecoder, pad_id: int, bos_id: int, eos_id: int):
        super().__init__()
